...
class ContinentalContentUtils {
	...
	{
		self::$fake_ip = $ip;
		Session::set('FAKE_IP', $ip);
		Session::save();
	}

	public static function get_fake_ip()
	{
		if(Session::get('FAKE_IP'))
			return Session::get('FAKE_IP');
		return self::$fake_ip;
	}

	public static function clear_fake_ip()
	{
	...
	public static function IPAddress(){
		if($ip = ContinentalContentUtils::get_fake_ip())
			return $ip;
